...
################################################################
# This is a generated script based on design: spi_benchmark
#
...
# source spi_benchmark_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set emio_spi1_sclk_o [ create_bd_port -dir O -from 0 -to 0 emio_spi1_sclk_o ]
  set emio_spi1_sclk_o_en [ create_bd_port -dir O -from 0 -to 0 emio_spi1_sclk_o_en ]
  set emio_spi1_sclk_i [ create_bd_port -dir I -from 0 -to 0 emio_spi1_sclk_i ]
  set emio_spi1_mosi_o [ create_bd_port -dir O -from 0 -to 0 emio_spi1_mosi_o ]
  set emio_spi1_mosi_o_en [ create_bd_port -dir O -from 0 -to 0 emio_spi1_mosi_o_en ]
  set emio_spi1_mosi_i [ create_bd_port -dir I -from 0 -to 0 emio_spi1_mosi_i ]
  set emio_spi1_miso_i [ create_bd_port -dir I -from 0 -to 0 emio_spi1_miso_i ]
  set emio_spi1_ss_o [ create_bd_port -dir O -from 0 -to 0 emio_spi1_ss_o ]
  set emio_spi1_ss_o_en [ create_bd_port -dir O -from 0 -to 0 emio_spi1_ss_o_en ]
...
\
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]
  ...
  connect_bd_net -net emio_spi1_mosi_i_1  [get_bd_ports emio_spi1_mosi_i] \
  [get_bd_pins zynq_ultra_ps_e_0/emio_spi1_m_i]
  connect_bd_net -net emio_spi1_sclk_i_1  [get_bd_ports emio_spi1_sclk_i] \
  [get_bd_pins zynq_ultra_ps_e_0/emio_spi1_sclk_i]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_spi1_m_o  [get_bd_pins zynq_ultra_ps_e_0/emio_spi1_m_o] \
  [get_bd_ports emio_spi1_mosi_o]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_spi1_sclk_o  [get_bd_pins zynq_ultra_ps_e_0/emio_spi1_sclk_o] \
  [get_bd_ports emio_spi1_sclk_o]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_spi1_ss_o_n  [get_bd_pins zynq_ultra_ps_e_0/emio_spi1_ss_o_n] \
  [get_bd_ports emio_spi1_ss_o]
